	...
	public static void main(String[] args) {
		...
		if (gatoo == true) {
			for (int i = 0; i < g; i++) {
				...
				System.out.println("Raça: " + GatoSelvagem.animal.get(i).getRaca());
			}
		}
		if (avee == true) {
			for (int i = 0; i < a; i++) {
				...
				System.out.println("Raça: "+Aves.animal.get(i).getRaca());
		...
		if (primataa == true) {
			for (int i = 0; i < p; i++) {
				...
				System.out.println("Raça: "+Primata.animal.get(i).getRaca());

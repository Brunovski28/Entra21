...
public class Main {
	...
	public static void main(String[] args) {
		...
		unidadeBlumenau.precolaranja = 5.50;
		unidadeBlumenau.macavendidas = 8;
		unidadeBlumenau.precomaca = 4.50;
		unidadeJoinville.laranjavendidas = 9;
		unidadeJoinville.precolaranja = 3.50;
		unidadeJoinville.macavendidas = 2;
		unidadeJoinville.precomaca = 8.50;
		unidadeFlorianopolis.laranjavendidas = 13;
		unidadeFlorianopolis.precolaranja = 3.50;
		unidadeFlorianopolis.macavendidas = 15;
